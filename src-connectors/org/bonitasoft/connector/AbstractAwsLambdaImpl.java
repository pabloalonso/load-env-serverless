 ...
 */
public abstract class AbstractAwsLambdaImpl extends AbstractConnector {
	...
	protected final static String QUALIFIER_INPUT_PARAMETER = "qualifier";
	...
	protected final java.lang.String getQualifier() {
		return (java.lang.String) getInputParameter(QUALIFIER_INPUT_PARAMETER);
	}
	...
	public void validateInputParameters() throws ConnectorValidationException {
		...
		try {
			...
			throw new ConnectorValidationException("qualifier type is invalid");
		}
		try {
